...
当前版本：`0.1.0`。M0～M12 的工程实现和自动化验收已经完成，具体证据见[实施状态](IMPLEMENTATION_STATUS.md)。

## 主要能力

- Web of Science Starter API 主检索，OpenAlex/Crossref 免费补全，以及 WoS Plain Text、RIS、XLSX 官方导出导入。
- 多知识库、标签、收藏、阅读状态、笔记、本地检索和 BibTeX/RIS/CSV 导出；文献可加入多个知识库，PDF 物理文件只保留一份。
- “全部文献”和每个知识库各有独立总笔记，提供可持续向下扩展的 PPT 式无限画布、文章卡片、文字、形状、线条、图片及常用排版工具。
