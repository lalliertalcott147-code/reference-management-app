...
| 知识库多对多关联、标签、状态、笔记、导出和回收站 | M6 | `backend/tests/library/`、`frontend/src/pages/LibraryPage.test.tsx`、浏览器持久化 E2E |
| 全部文献及各知识库独立的 PPT 式无限画布总笔记 | M6 | `backend/tests/storage/test_database.py`、`backend/tests/library/test_library.py`、`backend/tests/library/test_library_api.py`、`frontend/src/components/LibraryWorkspace.test.tsx`、`frontend/src/pages/LibraryPage.test.tsx` |
